...
type AllCombinations<U extends string> = 
[U] extends [never]
? ''
: ''|{
    [P in U]:` ${P}${AllCombinations<Exclude<U,P>>}`
  }[U]
...
type Combination<T extends string[]> = 
{
  ...
  [P in T[number]]:`${P}${AllCombinations<Exclude<T[number],P>>}`

}[T[number]]

type see = Combination<['foo', 'bar', 'baz']>
