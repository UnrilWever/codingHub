...
// type getElement<L extends any[],R extends any[]> =
// L['length'] extends R['length'] 
// ? [getL<L>,getL<R>]
// : [getL<L>]


// type addL<T extends any[],Len extends number,L extends any[] = [],R extends any[] = []> = 
// [...L,...R]['length'] extends Len
// ? getElement<L,R>
// : T extends [infer N,...infer Rest]
//   ? addR<Rest,Len,[...L,N],R>
//   : never

// type addR<T extends any[],Len extends number,L extends any[] = [],R extends any[] = []> = 
// [...L,...R]['length'] extends Len
// ? getElement<L,R>
// : T extends [...infer Rest,infer N]
//   ? addL<Rest,Len,L,[...R,N]>
//   : never
