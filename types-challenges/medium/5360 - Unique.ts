...
type isElementInSet<T,S> = 
S extends [infer L,...infer R]
? Equal<T,L> extends true
  ? true
  : isElementInSet<T,R>
: false

type Unique<T,Cache extends any[] = []> = 
T extends [infer L ,... infer R]
? isElementInSet<L,Cache> extends true
  ? [...Unique<R,Cache>]
  : [...Unique<R,[...Cache,L]>]
: Cache

type see = Unique<[string, number, 1, 'a', 1, string, 2, 'b', 2, number]>
