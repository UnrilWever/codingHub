...
type NumberRange<L, H,Count extends number[] = [],Cache extends number[] = []> =
Count['length'] extends L
? Count['length'] extends H
  ? Cache[number] | H
  : NumberRange<[...Count,1]['length'],H,[...Count,1],[...Cache,Count['length']]>
: NumberRange<L,H,[...Count,1]> 


type see = NumberRange<2, 9>
